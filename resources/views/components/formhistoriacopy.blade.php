    ...
    <div class="row row-cols-4">
        <div class="col">
            ...
            <label for="cie10id_id">DX Principal</label>
                <select class="form-control" name="cie10id_id" value="{{old('cie10id_id')}}" required>
                    <option value=""></option>
                    @foreach ($cie10 as $cie10Item)
                        <option value="{{$cie10Item->id}}" {{(old('cie10id_id')==$cie10Item->id)? 'selected':''}}> {{$cie10Item->codigo . "-" . $cie10Item->nombre}}</option> 
                    @endforeach
                </select>
        ...
        <div class="col">
            ...
            <label for="cie10id_id2">DX Secundario</label>
                <select class="form-control" name="cie10id_id2" value="{{old('cie10id_id2')}}">
                    <option value=""></option>
                    @foreach ($cie10 as $cie10Item)
                        <option value="{{$cie10Item->id}}" {{(old('cie10id_id2')==$cie10Item->id)? 'selected':''}}> {{$cie10Item->codigo . "-" . $cie10Item->nombre}}</option> 
                    @endforeach
                </select>
            </div>
        </div>
