...
return [
    ...
    'custom'               => [
        ...
        'usersid_id' => [
            'required' => 'Error de logueo, salga del sistema y vuelva a ingresar.',
        ],
        'clienteid_id' => [
            'required' => 'Cliente no existe, debe crearlo.',
        ],
        'prinomh' => [
            'required' => 'Cliente no existe, debe crearlo.',
        ],
        ...
        'facturasid_id' => [
            'required' => 'Debe incluir un cliente en la factura',
        ],        
        'total' => [
            'min' => 'Debe incluir items a la factura.',
        ],        
        'fechaini' => [
            'before' => 'La fecha inicial no puede ser mayor o igual a hoy.',
        ],   
        'fechafin' => [
            'before' => 'La fecha final no puede ser mayor o igual a hoy.',
            'after' => 'La fecha final no puede ser menor a la fecha inicial.',
        ],  
    ...
    'attributes'           => [
        ...
        'productosid_id'           => 'Item de factura',
